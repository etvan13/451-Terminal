...
class Terminal:
    def __init__(self):
        ...
        self.commands = {
            ...
            "ghidra reverse": (self.ghidra_command, "Runs Ghidra reversing tools."),
            "simple bruteforce": (self.simple_brute_force_command, "Executes a simple brute force generator."),
            ...
            "bruteforce timing": (self.timeEstimate, "Estimates time required for a brute force generator."),
            "binwalk": (self.binwalk_command, "Analyzes binaries for data."),
